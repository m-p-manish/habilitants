 ...
 */
@Entity
@Table(name = "ROLESLINK", schema="SPOPOFF")
@NamedQueries({
...
public class Roleslink implements Serializable {
    ...
    public String sqlInsert(String schemaa){
        return "INSERT INTO "+schemaa+"ROLESLINK (PKROLELINK, ACTIVE, FKPARENTROLE, FKCHILDROLE) VALUES ("+pkrolelink+","+active+","+fkparentrole.getPkrole()+","+fkchildrole.getPkrole()+")";
    }
    /**
    ...
    public String sqlUpdate(String schemaa){
        return "UPDATE INTO "+schemaa+"ROLESLINK (PKROLELINK, ACTIVE, FKPARENTROLE, FKCHILDROLE) VALUES ("+pkrolelink+","+active+","+fkparentrole.getPkrole()+","+fkchildrole.getPkrole()+")";
    }
