 ...
 */
@Entity
@Table(name = "PERMISSIONS", schema="SPOPOFF")
@NamedQueries({
...
public class Permissions implements Serializable {
    ...
    public String sqlInsert(String schemaa){
        return "INSERT INTO "+schemaa+"PERMISSIONS (PKPERMISSIONS, ACTIVE, FKHABILITANT, FKROLE) VALUES ("+pkpermissions+","+active+","+","+fkhabilitant+","+fkrole.getPkrole()+")";
    }
    /**
    ...
    public String sqlUpdate(String schemaa){
        return "UPDATE INTO "+schemaa+"PERMISSIONS (PKPERMISSIONS, ACTIVE, FKHABILITANT, FKROLE) VALUES ("+pkpermissions+","+active+","+","+fkhabilitant+","+fkrole.getPkrole()+")";
    }
