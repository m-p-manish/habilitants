 ...
 */
@Entity
@Table(name = "OBJS_ATTRS", schema="SPOPOFF")
@NamedQueries({
...
public class ObjsAttrs extends Attributs implements Serializable {
    ...
    public String toString() {
        return "pkattrObjs=" + pkattrObjs + " fkobjs="+fkobjs.getPkobjs();
    }
    /**
    ...
    public String sqlInsert(String schemaa){
        return "INSERT INTO "+schemaa+"OBJS_ATTRS (PKATTR_OBJS, FKOBJS, VAL, ATTR) VALUES ("+pkattrObjs+","+fkobjs.getPkobjs()+",'"+super.getVal()+"','"+super.getAttr()+"')";
    }
    /**
    ...
    public String sqlUpdate(String schemaa){
        return "UPDATE INTO "+schemaa+"OBJS_ATTRS (PKATTR_OBJS, FKOBJS, VAL, ATTR) VALUES ("+pkattrObjs+","+fkobjs.getPkobjs()+",'"+super.getVal()+"','"+super.getAttr()+"')";
    }
}
