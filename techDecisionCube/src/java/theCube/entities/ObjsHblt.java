 ...
 */
@Entity
@Table(name = "OBJS_HBLT", schema="SPOPOFF")
...
public class ObjsHblt implements Serializable {
    ...
    public String sqlInsert(String schemaa){
        return "INSERT INTO "+schemaa+"OBJS_HBLT (PKOBJS_HBLT, FKHBLT, FKOBJS) VALUES ("+pkobjsHblt+","+fkhblt.getPkhblt()+","+fkobjs.getPkobjs()+")";
    }
    /**
    ...
    public String sqlUpdate(String schemaa){
        return "UPDATE INTO "+schemaa+"OBJS_HBLT (PKOBJS_HBLT, FKHBLT, FKOBJS) VALUES ("+pkobjsHblt+","+fkhblt.getPkhblt()+","+fkobjs.getPkobjs()+")";
    }
