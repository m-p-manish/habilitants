 ...
 */
@Entity
@Table(name = "CPTE_ATTRS", schema="SPOPOFF")
@NamedQueries({
...
public class CpteAttrs extends Attributs implements Serializable {
    ...
    public String toString() {
        return "pkattrCpte=" + pkattrCpte + "fkcpte="+fkcpte.getPkcpte();
    }
    /**
    ...
    public String sqlInsert(String schemaa){
        return "INSERT INTO "+schemaa+"CPTE_ATTRS (PKATTR_CPTE, FKCPTE, ATTR, VAL) VALUES ("+pkattrCpte+","+fkcpte.getPkcpte()+",'"+super.getAttr()+"','"+super.getVal()+"')";
    }
    /**
    ...
    public String sqlUpdate(String schemaa){
        return "UPDATE INTO "+schemaa+"CPTE_ATTRS (PKATTR_CPTE, FKCPTE, ATTR, VAL) VALUES ("+pkattrCpte+","+fkcpte.getPkcpte()+",'"+super.getAttr()+"','"+super.getVal()+"')";
    }
