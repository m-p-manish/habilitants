 ...
 */
@Remote
public interface IIdntCpteDaoRemote extends IIdntCpteDao {
    void create(IdntCpte idntCpte) throws PreexistingEntityException, RollbackFailureException, Exception;

    void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception;

    void edit(IdntCpte idntCpte) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception;
    ...
    List<IdntCpte> relatedIdnt(int idCpte);

    List<IdntCpte> relatedCpte(int idIdnt);
}
