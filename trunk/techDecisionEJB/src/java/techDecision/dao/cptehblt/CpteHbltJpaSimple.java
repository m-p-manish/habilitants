...
public class CpteHbltJpaSimple {

    private EntityManager em = null;

    CpteHbltJpaSimple(EntityManager emm) {
        em = emm;
    }
    ...
    public List<CpteHblt> relatedHblt(int idCpte){
        List<CpteHblt> ret = null;
        try {
            Query qHbltVal = em.createNativeQuery("SELECT * FROM CPTE_HBLT WHERE FKCPTE = ?fkcpte", CpteHblt.class);
    ...
    public List<CpteHblt> relatedCpte(int idHblt){
        List<CpteHblt> ret = null;
        try {
            Query qHbltVal = em.createNativeQuery("SELECT * FROM CPTE_HBLT WHERE FKHBLT = ?fkhblt", CpteHblt.class);
