 ...
 */
@Remote
public interface IObjsAttrsDaoRemote extends IObjsAttrsDao {
    void create(ObjsAttrs objsAttrs) throws PreexistingEntityException, RollbackFailureException, Exception;

    void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception;

    void edit(ObjsAttrs objsAttrs) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception;
    ...
    List<ObjsAttrs> relatedAttrs(int idObjs);

    Boolean existNomAppli(String sNom);
}
