/*
Copyright Stéphane Georges Popoff, (avril 209 - marss 2010)
 ...
 */
@Remote
public interface IIdntattrDaoRemote extends IIdntattrDao {
    void create(IdntAttrs dntattr) throws PreexistingEntityException, RollbackFailureException, Exception;

    void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception;

    void edit(IdntAttrs idntattr) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception;
