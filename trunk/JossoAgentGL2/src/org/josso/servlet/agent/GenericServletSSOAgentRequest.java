...
public class GenericServletSSOAgentRequest extends HttpSSOAgentRequest {
    ...
    public GenericServletSSOAgentRequest(int action, String sessionId, LocalSession session, String assertionId) {
        super(action, sessionId, session, assertionId);
    }

    public GenericServletSSOAgentRequest(int action, String sessionId, LocalSession session) {
