...
public interface ICritere {
     /**
     * Retourne la note pour un critère donné
     * @return une note entre 0 et 1
     * @param compte un compte
     */
    Double getNoteCritere(Object compte);
     /**
     * Retourne la pondération du critère
     * @return un poids entre 1 et 100
     */
    int getPonderation();
    /**
