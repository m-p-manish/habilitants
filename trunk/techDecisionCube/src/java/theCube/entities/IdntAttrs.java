 ...
 */
@Entity
@Table(name = "IDNT_ATTRS", schema="SPOPOFF")
...
public class IdntAttrs extends Attributs implements Serializable {
    ...
    public String toString() {
        return "pkattrIdnt=" + pkattrIdnt + " fkidnt="+fkidnt.getPkidnt();
    }
    /**
    ...
    public String sqlInsert(String schemaa){
        return "INSERT INTO "+schemaa+"IDNT_ATTRS (PKATTR_IDNT, FKIDNT, VAL, ATTR) VALUES ("+pkattrIdnt+","+fkidnt.getPkidnt()+",'"+super.getVal()+"','"+super.getAttr()+"')";
    }
    /**
    ...
    public String sqlUpdate(String schemaa){
        return "UPDATE INTO "+schemaa+"IDNT_ATTRS (PKATTR_IDNT, FKIDNT, VAL, ATTR) VALUES ("+pkattrIdnt+","+fkidnt.getPkidnt()+",'"+super.getVal()+"','"+super.getAttr()+"')";
    }
