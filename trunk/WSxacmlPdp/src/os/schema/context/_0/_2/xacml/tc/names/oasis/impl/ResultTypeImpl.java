...
public class ResultTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements os.schema.context._0._2.xacml.tc.names.oasis.ResultType
{
    ...
    public java.lang.String getResourceId()
    {
        synchronized (monitor())
        {
            check_orphaned();
            org.apache.xmlbeans.SimpleValue target = null;
            target = (org.apache.xmlbeans.SimpleValue)get_store().find_attribute_user(RESOURCEID$4);
            if (target == null)
            {
                return null;
            }
    ...
    public org.apache.xmlbeans.XmlString xgetResourceId()
    {
        synchronized (monitor())
        {
            ...
            target = (org.apache.xmlbeans.XmlString)get_store().find_attribute_user(RESOURCEID$4);
            return target;
        }
    }
    ...
    public boolean isSetResourceId()
    {
        ...
        {
            check_orphaned();
            return get_store().find_attribute_user(RESOURCEID$4) != null;
        }
    }
    ...
    public void setResourceId(java.lang.String resourceId)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.SimpleValue)get_store().add_attribute_user(RESOURCEID$4);
            }
    ...
    public void xsetResourceId(org.apache.xmlbeans.XmlString resourceId)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (org.apache.xmlbeans.XmlString)get_store().add_attribute_user(RESOURCEID$4);
            }
    ...
    public void unsetResourceId()
    {
        ...
        {
            check_orphaned();
            get_store().remove_attribute(RESOURCEID$4);
        }
    }
}
