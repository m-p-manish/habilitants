...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New ObjsCpte</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{objsCpte.validateCreate}" value="value"/>
                ...
                <br />
                <h:commandLink action="#{objsCpte.create}" value="Create"/>
                <br />
                <br />
