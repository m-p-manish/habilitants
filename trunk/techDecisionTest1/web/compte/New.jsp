...
<f:view>
    <html>
        ...
        <body>
            ...
            <h1>New Compte</h1>
            <h:form>
                <h:inputHidden id="validateCreateField" validator="#{compte.validateCreate}" value="value"/>
                <h:panelGrid columns="2">
                    <h:outputText value="Pkcpte:"/>
                    <h:inputText id="pkcpte" value="#{compte.compte.pkcpte}" title="Pkcpte" required="true" requiredMessage="The pkcpte field is required." />
                ...
                <br />
                <h:commandLink action="#{compte.create}" value="Create"/>
                <br />
                <br />
