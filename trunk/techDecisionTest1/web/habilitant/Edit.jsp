...
<f:view>
    <html>
        <head>
            ...
            <title>Editing Habilitant</title>
        ...
        <body>
            ...
            <h:form>
                ...
                <br />
                <h:commandLink action="#{habilitant.edit}" value="Save">
                ...
                <br />
                <br />
                <h:commandLink action="#{habilitant.detailSetup}" value="Show" immediate="true">
                    <f:param name="jsfcrud.currentHabilitant" value="#{jsfcrud_class['test1Jsf.util.JsfUtil'].jsfcrud_method['getAsConvertedString'][habilitant.habilitant][habilitant.converter].jsfcrud_invoke}"/>
                </h:commandLink>
                <br />
