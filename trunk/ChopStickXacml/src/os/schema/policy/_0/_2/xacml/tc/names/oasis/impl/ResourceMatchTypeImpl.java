 ...
 */
public class ResourceMatchTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements os.schema.policy._0._2.xacml.tc.names.oasis.ResourceMatchType
{
    
    public ResourceMatchTypeImpl(org.apache.xmlbeans.SchemaType sType)
    {
        super(sType);
    }
    ...
    private static final javax.xml.namespace.QName RESOURCEATTRIBUTEDESIGNATOR$2 = 
    ...
    public os.schema.policy._0._2.xacml.tc.names.oasis.AttributeDesignatorType getResourceAttributeDesignator()
    {
        synchronized (monitor())
        {
            ...
            target = (os.schema.policy._0._2.xacml.tc.names.oasis.AttributeDesignatorType)get_store().find_element_user(RESOURCEATTRIBUTEDESIGNATOR$2, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public boolean isSetResourceAttributeDesignator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            return get_store().count_elements(RESOURCEATTRIBUTEDESIGNATOR$2) != 0;
        }
    }
    ...
    public void setResourceAttributeDesignator(os.schema.policy._0._2.xacml.tc.names.oasis.AttributeDesignatorType resourceAttributeDesignator)
    {
        synchronized (monitor())
        {
            ...
            if (target == null)
            {
                target = (os.schema.policy._0._2.xacml.tc.names.oasis.AttributeDesignatorType)get_store().add_element_user(RESOURCEATTRIBUTEDESIGNATOR$2);
            }
     ...
     */
    public void unsetResourceAttributeDesignator()
    {
        synchronized (monitor())
        {
            check_orphaned();
            get_store().remove_element(RESOURCEATTRIBUTEDESIGNATOR$2, 0);
        }
    }
