...
public abstract class AbstractSSOAgent implements SSOAgent {
    ...
    protected String resolveAssertion(String assertionId) {
        ...
        try {
            ...
            String ssoSessionId = ip.resolveAuthenticationAssertion(assertionId);
            return ssoSessionId;
     ...
     */
    protected void accessSession(String jossoSessionId) throws SSOSessionException {
