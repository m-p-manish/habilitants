 ...
 */
@Remote
public interface ICpteAttrsDaoRemote extends ICpteAttrsDao {
    void create(CpteAttrs cpteAttrs) throws PreexistingEntityException, RollbackFailureException, Exception;

    void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception;

    void edit(CpteAttrs cpteAttrs) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception;
    ...
    List<CpteAttrs> relatedAttrs(int idCpte);
}
