 ...
 */
@Remote
public interface IObjsHbltDaoRemote extends IObjsHbltDao {
    void create(ObjsHblt objsHblt) throws PreexistingEntityException, RollbackFailureException, Exception;

    void destroy(Integer id) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception;

    void edit(ObjsHblt objsHblt) throws IllegalOrphanException, NonexistentEntityException, RollbackFailureException, Exception;
    ...
    List<ObjsHblt> relatedObjs(int idHblt);

    List<ObjsHblt> relatedHblt(int idObjs);
}
