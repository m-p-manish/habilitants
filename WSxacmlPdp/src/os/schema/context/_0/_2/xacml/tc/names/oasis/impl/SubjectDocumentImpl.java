 ...
 */
public class SubjectDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements os.schema.context._0._2.xacml.tc.names.oasis.SubjectDocument
{
     ...
     */
    public os.schema.context._0._2.xacml.tc.names.oasis.SubjectType getSubject()
    {
        synchronized (monitor())
        {
            check_orphaned();
            os.schema.context._0._2.xacml.tc.names.oasis.SubjectType target = null;
            target = (os.schema.context._0._2.xacml.tc.names.oasis.SubjectType)get_store().find_element_user(SUBJECT$0, 0);
            if (target == null)
            {
                return null;
            }
     ...
     */
    public void setSubject(os.schema.context._0._2.xacml.tc.names.oasis.SubjectType subject)
    {
        synchronized (monitor())
        {
            check_orphaned();
